...
namespace ToDoBackend.Migrations
{
    ...
    [Migration("20250907115920_RemoveTitleIndex")]
    partial class RemoveTitleIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoBackend.Models.ToDoItem.ToDoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ToDoBackend.Models.ToDoItem.ToDoItem", b =>
                {
                    b.OwnsOne("ToDoBackend.Models.AuditInfo", "AuditInfo", b1 =>
                        {
                    ...
                    b.OwnsOne("ToDoBackend.Models.ToDoItem.CompletionInfo", "CompletionInfo", b1 =>
                        {
                            b1.Property<Guid>("ToDoItemId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ToDoBackend.Models.ToDoItem.ScheduleInfo", "ScheduleInfo", b1 =>
                        {
                            b1.Property<Guid>("ToDoItemId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
